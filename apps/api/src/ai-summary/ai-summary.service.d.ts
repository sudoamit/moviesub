...
export declare class AISummaryService {
    ...
    constructor(signalsService: SignalsService, smcService: SMCService);
    generateSymbolSummary(symbol: string, timeframe?: Timeframe): Promise<{
        symbol: string;
        timeframe: Timeframe;
        bias: string;
        score: number;
    ...
    generateDailyBriefing(timeframe?: Timeframe): Promise<{
        title: string;
        date: string;
        marketBreadth: {
