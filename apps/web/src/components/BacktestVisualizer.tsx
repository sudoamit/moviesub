...
export const BacktestVisualizer: React.FC<BacktestVisualizerProps> = ({
  ...
  const renderEquityCurve = (curve: any[]) => {
  ...
  return (
    <div className="bg-[#111827]/80 backdrop-blur border border-slate-800 rounded-xl p-5 shadow-lg space-y-5">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-5 gap-3 text-xs">
        <div>
          ...
          <select
            ...
            className="w-full bg-slate-900 border border-slate-700 rounded px-2.5 py-1.5 text-white font-mono focus:outline-none"
          >
        ...
        <div className="flex items-end">
          <button
            onClick={handleRun}
            disabled={isLoading}
            className="w-full bg-cyan-500 hover:bg-cyan-400 text-slate-950 font-bold py-1.5 px-3 rounded flex items-center justify-center gap-1.5 transition-all text-xs shadow-md disabled:opacity-50"
          >
