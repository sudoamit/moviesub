...
import { BarChart3, Layers, SlidersHorizontal, Maximize2 } from 'lucide-react';

export function ChartPlaceholder({ symbol }: { symbol: string }) {
  return (
    <div className="bg-surface rounded-xl border border-surface-border flex flex-col h-full overflow-hidden">
      {/* Chart Toolbar */}
