...
function SidePanel({ symbol }) {
    return (<div className="bg-surface rounded-xl border border-surface-border p-4 flex flex-col gap-5 h-full overflow-y-auto font-mono text-xs">
      {/* Header Summary */}
      ...
      <div className="space-y-2 bg-slate-900/60 p-3 rounded-lg border border-surface-border">
        <div className="text-[11px] font-semibold text-slate-300 flex items-center gap-1.5 mb-2">
          <lucide_react_1.Crosshair className="w-3.5 h-3.5 text-indigo-400"/>
      ...
      <div className="space-y-2">
        <div className="text-[11px] font-semibold text-slate-300 flex items-center gap-1.5">
          <lucide_react_1.Compass className="w-3.5 h-3.5 text-indigo-400"/>
      ...
      <div className="space-y-2">
        <div className="text-[11px] font-semibold text-slate-300 flex items-center gap-1.5">
          <lucide_react_1.TrendingUp className="w-3.5 h-3.5 text-emerald-400"/>
      ...
      <div className="space-y-2">
        <div className="text-[11px] font-semibold text-slate-300 flex items-center gap-1.5">
          <lucide_react_1.ShieldAlert className="w-3.5 h-3.5 text-amber-400"/>
        ...
        <div className="space-y-1.5 bg-amber-950/20 p-3 rounded-lg border border-amber-900/30 text-[11px]">
          <div className="flex items-start gap-2 text-amber-200/90">
            <lucide_react_1.AlertTriangle className="w-3.5 h-3.5 text-amber-400 shrink-0 mt-0.5"/>
