...
export const SmartStrikeCard: React.FC<SmartStrikeCardProps> = ({
  symbol,
  direction,
  spotPrice,
  onOpenChain,
  ...
  return (
    <div className="bg-[#111827]/95 border border-cyan-500/40 rounded-xl p-4 shadow-xl font-mono relative overflow-hidden">
      {/* Background Accent */}
      <div
        className={`absolute -top-10 -right-10 w-32 h-32 rounded-full blur-2xl opacity-15 pointer-events-none ${
      ...
      <div className="flex items-center justify-between border-b border-slate-800 pb-2.5">
        ...
        <button
          onClick={onOpenChain}
          className="bg-slate-900 hover:bg-slate-800 text-cyan-300 border border-cyan-500/40 px-2.5 py-1 rounded-md text-[11px] font-bold flex items-center gap-1 transition-all"
        >
        ...
        <div className="mt-3 space-y-3">
          ...
          <div className="flex flex-wrap items-center justify-between gap-2 bg-slate-900/90 border border-slate-800 p-3 rounded-lg">
            ...
            <div className="text-right">
              ...
              <span
                className={`text-xl font-black block transition-all duration-300 ${
                  priceFlash === 'up'
