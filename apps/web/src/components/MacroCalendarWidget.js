...
exports.MacroCalendarWidget = void 0;
const react_1 = __importStar(require("react"));
const lucide_react_1 = require("lucide-react");
const MacroCalendarWidget = () => {
    const [calendarData, setCalendarData] = (0, react_1.useState)(null);
    const [vixData, setVixData] = (0, react_1.useState)(null);
    ...
    return (<div className="space-y-5 font-mono">
      ...
      <div className="bg-[#111827]/95 backdrop-blur-md border border-cyan-500/30 rounded-xl p-5 shadow-2xl space-y-4">
        <div className="flex flex-wrap items-center justify-between gap-3 border-b border-slate-800 pb-3">
          ...
          {vixData && (<div className="flex items-center gap-3 bg-slate-900 border border-slate-800 px-3.5 py-1.5 rounded-xl text-xs">
              <div>
        ...
        {vixData && (<div className="p-3.5 rounded-xl bg-slate-900/90 border border-slate-800 flex items-start gap-3">
        ...
        <div className="space-y-3 pt-2">
          <h4 className="text-xs font-bold text-slate-400 uppercase tracking-wider flex items-center justify-between">
            ...
            <span className="text-[10px] text-amber-400 flex items-center gap-1 font-bold">
              <lucide_react_1.AlertTriangle className="w-3.5 h-3.5 text-amber-400"/>
          ...
          <div className="space-y-3">
            ...
            return (<div key={ev.id} className={`p-4 rounded-xl border transition-all ${isHigh
                  ...
                  <div className="flex flex-wrap items-start justify-between gap-2 border-b border-slate-800/80 pb-2.5">
                    <div>
                      <div className="flex items-center gap-2">
                        <span className={`text-[9px] font-black px-2 py-0.5 rounded border ${isHigh
                  ...
                  <div className="py-2.5 grid grid-cols-1 sm:grid-cols-3 gap-3 text-xs">
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-1 mt-0.5">
                        {ev.affectedInstruments?.map((sym) => (<span key={sym} className="bg-cyan-500/10 text-cyan-300 text-[9px] px-1.5 py-0.5 rounded border border-cyan-500/20 font-bold">
                            {sym}
                          </span>))}
                      </div>
                    </div>
                  ...
                  <div className="p-2.5 rounded-lg bg-slate-950 border border-slate-800 text-[11px] text-slate-300 font-sans flex items-start gap-2">
                    <lucide_react_1.Info className="w-3.5 h-3.5 text-cyan-400 shrink-0 mt-0.5"/>
                    <span>
...
exports.MacroCalendarWidget = MacroCalendarWidget;
//# sourceMappingURL=MacroCalendarWidget.js.map