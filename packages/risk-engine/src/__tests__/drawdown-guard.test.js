...
const drawdown_guard_1 = require("../drawdown-guard");
describe('DrawdownGuard', () => {
    it('should halt trading when maximum account drawdown (10%) is breached', () => {
        ...
        const status = drawdown_guard_1.DrawdownGuard.evaluateDrawdown(current, peak, startDay, {
...
//# sourceMappingURL=drawdown-guard.test.js.map