...
const execution_safety_gate_1 = require("../execution-safety-gate");
...
describe('ExecutionSafetyGate', () => {
    ...
    it('should approve a fully compliant SMC + ML candidate trade', () => {
        ...
        const result = execution_safety_gate_1.ExecutionSafetyGate.evaluate(params);
...
//# sourceMappingURL=execution-safety-gate.test.js.map