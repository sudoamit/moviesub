...
class PortfolioRiskManager {
     ...
     * STRICT FAIL-CLOSED.
     */
    static validateNewPosition(accountEquity, openPositions, proposedPosition, arg4, arg5, arg6, metrics = {}) {
        ...
        else if (metrics.dailyRealizedPnL !== undefined &&
        ...
        else if (metrics.weeklyRealizedPnL !== undefined &&
        ...
        else if (metrics.currentDrawdownPercent !== undefined &&
        ...
        else if (metrics.consecutiveLosses !== undefined &&
...
//# sourceMappingURL=portfolio-risk-manager.js.map