...
exports.DrawdownGuard = void 0;
class DrawdownGuard {
    /**
     * Evaluates equity curve and drawdown limits to protect capital
     */
    static evaluateDrawdown(currentEquity, peakEquity, startingDayEquity, options = {}) {
        ...
        else if (dailyDrawdownPercent >= maxDailyDD * 0.7 ||
...
exports.DrawdownGuard = DrawdownGuard;
//# sourceMappingURL=drawdown-guard.js.map