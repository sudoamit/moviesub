...
class NoTradeEngine {
     ...
     */
    static evaluateTradePermission(signal, context = {}) {
        const reasons = [];
        const explanations = [];
        ...
        if (context.correlatedExposurePercent !== undefined &&
...
exports.NoTradeEngine = NoTradeEngine;
//# sourceMappingURL=no-trade-engine.js.map