...
exports.CandleNormalizer = void 0;
class CandleNormalizer {
    ...
    static getCandleCloseTimestamp(candle, timeframe) {
     ...
     */
    static normalize(candles, options = {}) {
        ...
        if (enforceSorted) {
            sorted = [...validCandles].sort((a, b) => a.timestamp.getTime() - b.timestamp.getTime());
        }
...
exports.CandleNormalizer = CandleNormalizer;
