import { AssetType, Direction, MarketRegimeType, SignalGrade } from '@quant/shared';
...
export interface SMCQuantState {
    ...
    premiumDiscountPosition: number;
