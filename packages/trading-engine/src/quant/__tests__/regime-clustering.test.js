...
describe('RegimeClusteringEngine', () => {
    const createMockCandles = (count = 60, trendSlope = 1.0) => {
    ...
    it('should run K-Means clustering deterministically', () => {
        ...
        const res = regime_clustering_engine_1.RegimeClusteringEngine.runKMeans(data, 2, 10);
    ...
    it('should classify strong upward momentum as BULLISH_TREND', () => {
        ...
        const regimeState = regime_clustering_engine_1.RegimeClusteringEngine.classifyRegime(bullCandles);
...
//# sourceMappingURL=regime-clustering.test.js.map