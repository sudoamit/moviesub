...
describe('ReturnAnalysisEngine', () => {
    it('should return zeros for empty or single element closes array', () => {
        const res = return_analysis_1.ReturnAnalysisEngine.calculate([]);
    ...
    it('should accurately calculate multi-bar returns', () => {
        ...
        const res = return_analysis_1.ReturnAnalysisEngine.calculate(closes);
...
//# sourceMappingURL=return-analysis.test.js.map