...
describe('SnapshotBuilder', () => {
    const createMockCandles = (count = 50, base = 24000) => {
    ...
    it('should ignore future candles when asOfTimestamp is supplied to multi-horizon analysis', () => {
        ...
        const historical = multi_horizon_engine_1.MultiHorizonEngine.evaluateMultiHorizon(baseCandles, baseCandles, baseCandles, {
            asOfTimestamp: asOf,
            executionTimeframe: '15m',
            htfTimeframe: '1h',
            macroTimeframe: '4h',
        });
        const withFuture = multi_horizon_engine_1.MultiHorizonEngine.evaluateMultiHorizon(futureCandles, futureCandles, futureCandles, {
            asOfTimestamp: asOf,
            executionTimeframe: '15m',
            htfTimeframe: '1h',
            macroTimeframe: '4h',
...
//# sourceMappingURL=snapshot-builder.test.js.map