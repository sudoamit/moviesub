...
describe('PHASE 10: Deterministic Post-Mortem Failure & Success Analytics', () => {
    ...
    const createCandle = (offsetMinutes, open, high, low, close) => ({
    ...
    describe('1. MFE / MAE & Target Excursion Metrics in R-Multiples', () => {
        it('accurately computes MFE and MAE for Bullish trades reaching target', () => {
            ...
            const report = ai_trade_learning_engine_1.PostMortemAnalyticsEngine.analyzeTrade({
                symbol: 'NIFTY',
                direction: 'BULLISH',
                entryPrice: 100,
                stopLoss: 90,
...
//# sourceMappingURL=post-mortem-analytics.test.js.map