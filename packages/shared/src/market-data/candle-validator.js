...
class CandleValidator {
     ...
     */
    static normalizeAndCleanSeries(candles) {
        ...
        const sortedCandles = Array.from(validMap.values()).sort((a, b) => a.timestamp.getTime() - b.timestamp.getTime());
        return {
     ...
     */
    static validateDataQuality(candles, symbol, timeframe = '15m', maxAllowedStalenessMs = 30 * 60 * 1000) {
        const reasons = [];
        const now = Date.now();
...
//# sourceMappingURL=candle-validator.js.map