...
export class MockMarketDataProvider implements IMarketDataProvider {
  ...
  > = {
    ...
    NIFTY_SPOT: { basePrice: 24175, volatility: 0.0035, baseVolume: 250000, decimals: 2 },
    BANKNIFTY_SPOT: { basePrice: 51200, volatility: 0.0055, baseVolume: 180000, decimals: 2 },
    BTCUSDT_SPOT: { basePrice: 92500, volatility: 0.0085, baseVolume: 1500, decimals: 2 },
