...
class ExperimentRunner {
     ...
     */
    static runExperiment(name, splits, parameters = {}, randomSeed = 42) {
        ...
        const costStressTests = costMultipliers.map((multiplier) => {
            ...
            const profitFactor = netExpectancyR > 0
    ...
    static evaluatePartition(samples) {
    ...
    static simulateMonteCarlo(samples, seed) {
        if (!samples || samples.length === 0) {
