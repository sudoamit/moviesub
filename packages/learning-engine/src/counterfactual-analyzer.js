...
exports.CounterfactualAnalyzer = void 0;
class CounterfactualAnalyzer {
    ...
    static analyzeExperience(exp) {
        ...
        const opportunityLossR = Math.max(0, Number((optimalScenario.simulatedPnLR - actualPnLR).toFixed(2)));
        return {
     ...
     */
    static analyzeBatch(experiences) {
        ...
        const tp2Wins = analyses.filter((a) => a.optimalScenario.scenarioName === 'TP2_STANDARD').length;
        const beWins = analyses.filter((a) => a.optimalScenario.scenarioName === 'TRAILING_BREAKEVEN').length;
        const count = analyses.length;
        let recommended = 'TP2_STANDARD';
        if (tp1Wins > tp2Wins && tp1Wins > beWins)
            recommended = 'TP1_FIXED';
        if (beWins > tp1Wins && beWins > tp2Wins)
            recommended = 'TRAILING_BREAKEVEN';
        return {
...
exports.CounterfactualAnalyzer = CounterfactualAnalyzer;
//# sourceMappingURL=counterfactual-analyzer.js.map