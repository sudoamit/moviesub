...
describe('LearningEngine Pipeline', () => {
    beforeEach(() => {
        experience_store_1.ExperienceStore.clear();
    });
    const createMockDataset = (count = 40) => {
    ...
    it('should run a complete self-improvement learning cycle end-to-end', async () => {
        ...
        experience_store_1.ExperienceStore.loadExperiences(dataset);
        const report = await learning_engine_1.LearningEngine.runLearningCycle({
...
//# sourceMappingURL=learning-engine-pipeline.test.js.map